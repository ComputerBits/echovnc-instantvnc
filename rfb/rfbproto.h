...
#define USE_FILE_TRANSFER_CONFIRMATION
/*-----------------------------------------------------------------------------
...
#define rfbFileTransferConfirmHeader	15	//Server akwegdge the client that it is using the Confirm transfer type.
#define rfbFileTransferConfirmReply		16  //Confirmation reply on every received pocke
#endif
...
/*-----------------------------------------------------------------------------
 * Modif 2006
 * ControlMsg - Utilized to order the Control mode on server
 * client->server message
 */

typedef struct _rfbControlMsg {
    CARD8 type;			/* always rfbControl*/
    CARD8 pad1;         // Could be used later as an additionnal param
    CARD16 command;		//type of command 
} rfbControlMsg;

#define sz_rfbControlMsg 4

//commands

#define rfbReboot					1
#define rfbRebootAccessFailed		2
#define rfbRebootFunctionFailed		3
#define rfbViewerClose				4
